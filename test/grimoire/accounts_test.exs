defmodule Grimoire.AccountsTest do
    ...
    test "allows fields to be set" do
      changeset =
        Accounts.change_user_password(
          %User{},
          %{"password" => "my new valid password"},
          hash_password: false
        )

      assert changeset.valid?
      assert get_change(changeset, :password) == "my new valid password"
  ...
  describe "update_user_password/2" do
    ...
    test "validates password", %{user: user} do
      ...
      assert %{
               password: ["should be at least 20 character(s)"],
    ...
    test "updates the password", %{user: user} do
      ...
      assert is_nil(user.password)
      assert Accounts.get_user_by_email_and_password(user.email, "my new valid password")
    end
